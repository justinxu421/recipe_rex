...
class KNNRecSys():
    def __init__(self):
        ...
        self.embeddings_df_scaled = pd.read_csv('clean_data/embeddings_mvp_scaled.csv', index_col = 'url')
        self.url_index_mapping = pd.read_csv('clean_data/url_index_mapping.csv', index_col = 'url')    
